package fr.alasdiablo.diolib.data.blockstate;
 ...
 */
public record BlockStateVariant(String key, String model, int x, int y, boolean uvlock) {
    ...
    public static @NotNull BlockStateVariant of(String key, String model, int x, int y, boolean uvlock) {
