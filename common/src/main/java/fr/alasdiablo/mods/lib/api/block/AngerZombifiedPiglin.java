...
import fr.alasdiablo.mods.lib.config.DiaboloLibConfig;
...
public interface AngerZombifiedPiglin extends Anger {
    ...
    default void anger(Player player, Level world, Vec3i position) {
        this.anger(
                player, world, new Vec3(position.getX(), position.getY(), position.getZ()), DiaboloLibConfig.ZOMBIFIED_PIGLIN_ANGER.getAngerRange(),
